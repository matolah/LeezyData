...
protocol LocalDataServiceProtocol<DataType>: DataServiceProtocol where DataType: LocalEntity {
    func createEmpty() -> DataType?
}

final class LocalDataService<T: LocalEntity>: DataService<T>, LocalDataServiceProtocol {
